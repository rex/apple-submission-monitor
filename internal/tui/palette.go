...
func healthPalette(health domain.Health) palette {
	...
	case domain.HealthRed:
		return palette{
			...
			flash: "#65152A", ambient: "#250B12", shadow: "#5D1F2E",
			gradientA: "#FF4D6D", gradientB: "#FFB3C1",
		}
	case domain.HealthYellow:
		return palette{
			base: "#4F8CFF", bright: "#B9DEFF", background: "#071A3B",
			flash: "#143F82", ambient: "#0B2858", shadow: "#10366F",
			gradientA: "#77B7FF", gradientB: "#A7C7FF",
		}
	case domain.HealthGreen:
		return palette{
			base: "#5AF78E", bright: "#A7F3D0", background: "#062319",
			flash: "#0C6247", ambient: "#062319", shadow: "#164C39",
			gradientA: "#34D399", gradientB: "#99F6E4",
		}
	case domain.HealthBlue:
		return palette{
			base: "#60A5FA", bright: "#BFDBFE", background: "#071B35",
			flash: "#124A87", ambient: "#092852", shadow: "#153A70",
			gradientA: "#38BDF8", gradientB: "#C4B5FD",
		}
	case domain.HealthPurple:
		return palette{
			base: "#C084FC", bright: "#E9D5FF", background: "#211030",
			flash: "#64338A", ambient: "#211030", shadow: "#512D6D",
			gradientA: "#A78BFA", gradientB: "#F0ABFC",
		}
	default:
		return palette{
			base: "#8B949E", bright: "#D0D7DE", background: "#11151A",
			flash: "#30363D", ambient: "#11151A", shadow: "#30363D",
			gradientA: "#8B949E", gradientB: "#D0D7DE",
		}
	}
}
